"""
    The code below crawls the corpus of the MADE 1.0 Train Data and stores them
    as corpus id, corpus content in the clinical.csv file.
    Input Files:
...
import csv
import os
path ="C:\\Project_NLP_Final\\Project Dataset\\made_train_data\\corpus\\"
dirListing = os.listdir(path)
files=list()
content=list()
content.append(["Content ID", "Content"])
for item in dirListing:
        data = open("C:\\Project_NLP_Final\\Project Dataset\\made_train_data\\corpus\\{}".format(item)).read()
...
with open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Normal\\clinical.csv",'w', encoding = 'utf8', newline='') as outcsv:   
