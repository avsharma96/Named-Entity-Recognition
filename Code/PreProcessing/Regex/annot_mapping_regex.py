...
clinical = open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Regex\\clinical.csv",'r', encoding = 'utf8', newline='')    
values= open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Regex\\CSV_Annotations.csv",'r', encoding = 'utf8', newline='')    
...
with open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Regex\\Corpus_Sentences.csv",'w', encoding = 'utf8', newline='') as outcsv:   
        writer = csv.writer(outcsv, delimiter=',',quotechar = '"')
        for row in list_of_sentence:
            case = [x.casefold() for x in row]
            writer.writerow(case)
            
with open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Regex\\Corpus_Sentences_Tags.csv",'w', encoding = 'utf8', newline='') as outcsv:   
        writer = csv.writer(outcsv, delimiter=',',quotechar = '"')
        for row in list_of_sentence_tag:
            writer.writerow(row)
            
with open("C:\\Project_NLP_Final\\Project Dataset\\PreProcessing\\Regex\\Corpus_POS_Tags.csv",'w', encoding = 'utf8', newline='') as outcsv:   
        writer = csv.writer(outcsv, delimiter=',',quotechar = '"')
